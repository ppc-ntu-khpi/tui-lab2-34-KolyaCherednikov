...
public class CLIdemo {
            ...
            if ("help".equals(line)) {
                ...
                try {
                    ...
                    for(int i = 0;i<cust.getNumberOfAccounts();i++){
                        String accType = cust.getAccount(i) instanceof CheckingAccount ? "Checkinh" : "Savings";
                        System.out.println(cust.getLastName() + "\t\t" + cust.getFirstName() + "\t\t" + accType + " \t$" + cust.getAccount(i).getBalance());
                    }
                } catch (Exception e) {
                    System.out
    ...
    private void printHelp() {
        ...
        System.out.println("report\t\t\t- Create report");
    ...
    public static void main(String[] args) throws Exception{  
        ...
        try {
            ...
            Logger.getLogger(CLIdemo.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}